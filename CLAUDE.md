...
When working on this repo (the TAFS subvention calculator), follow these rules:

1. **Don't assume you know the answer.** If anything is unclear, ask — don't guess.

2. **Don't make any changes until you get permission from me.** Propose first, wait for go-ahead, then act.
